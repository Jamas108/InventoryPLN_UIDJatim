        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Barang Keluar Reguler</h1>
                        ...
                        <div class="table-responsive">
                            <table class="table text-start align-middle table-bordered table-hover mb-0 datatable"
                                ...
                                <thead style="background-color: rgb(1, 1, 95);">
                                    <tr>
                                        <th scope="col" style="color:white">Surat Jalan</th>
                                        <th scope="col" style="color:white">Berita Acara</th>
                                        <th scope="col" style="color:white">Kode Barang Keluar</th>
                                        <th scope="col" style="color:white">Jumlah Barang</th>
                                        <th scope="col" style="color:white">Tanggal Keluar</th>
