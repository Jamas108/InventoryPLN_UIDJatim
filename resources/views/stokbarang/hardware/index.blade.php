                    ...
                    <div class="bg-white justify-content-between rounded shadow p-4">
                        ...
                        <div class="table-responsive">
                            <table class="table text-center align-middle  mb-0 datatable"
                                ...
                                <tbody>
                                    @foreach ($hardwareBarangMasuks as $barang)
                                        <tr>
                                            <td class="d-flex justify-content-center align-items-center">
                                                <div class="card"
                                                    style="display: flex; flex-direction: row; align-items: center; width:100%; background-color:transparent; border-color:transparent;">
