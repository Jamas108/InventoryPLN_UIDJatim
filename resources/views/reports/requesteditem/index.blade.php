            ...
            <section id="contact" class="contact">
                <div class="container" data-aos="fade-up">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Requested Item</h1>
                                    ...
                                    <table id="BarangmasukTable"  class="table table-striped datatable" >
                                        <thead>
                                            <tr style="color: rgb(255, 255, 255)">
                                                <th scope="col" style="width: 350px;">Nama Barang</th>
                                                <th scope="col" style="width: 350px;">Tanggal</th>
                                                <th scope="col" style="width: 350px;">Tahun</th>
                                                <th scope="col" style="width: 350px;">Jumlah Total</th>
                                            </tr>
                                        </thead>
                                </table>
                            </div>
